...
5. Game loop — lives, money, wave counter, game over screen ❌(parts done, not fully completed)
6. 2-3 tower types — e.g. basic, slow, splash damage ❌
7. 2-3 enemy types — e.g. fast/weak, slow/tanky, armored ❌(same enemy type through just increase the difficulty as wave numbers increase)
